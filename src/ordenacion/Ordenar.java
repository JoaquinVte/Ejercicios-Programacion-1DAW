...
public class Ordenar {
	public static void main (String[] args){
		...
		//int[] vector = {7,1,5,2,0,8,3,4,9,6};
		...
		_Quicksort(vector, 0, vector.length-1);
		long fin = System.currentTimeMillis();
		
		//mostrar(vector);
		System.out.printf("El tiempo empleado en ordenar el vector ha sido de : %s milisegundos", fin-inicio);
	}
...
/*	burbujaMejorada
	...
	Si a ese cambio le sumamos otro cambio, el hecho que los elementos que estan detrás 
	del que se esta comparando, ya estan ordenados, las comparaciones serian aun menos 
	y el metodo seria aun mas efectivo. Si tenemos una lista de 10 elementos y estamos 
	analizando el quinto elemento, que sentido tiene que el quinto se compare con el 
	primero, el segundo o el tercero, si supuestamente, ya estan ordenados? Entonces 
	optimizamos mas aun el algoritmo, quedando nuestra version final del algoritmo optimizado
*/
...
/*	burbujaMejorada
	Existe una otra forma muy obvia para mejorar el algoritmo de la burbuja. Basta con tener en
	cuenta la posibilidad de que el conjunto esté ordenado en algún paso intermedio. Si el
	bucle interno no necesita realizar ningún intercambio en alguna pasada, el conjunto estará
	ya ordenado. 
*/
...
/*	Quicksort
	...
	elemento pivote.  
*/	
	public static void _Quicksort(int[] arreglo, int a, int b){
